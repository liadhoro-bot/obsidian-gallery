...
export default function LoginExperience({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#030607] text-white">
      <Image
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-md flex-col justify-between px-4 pb-8 pt-3">
