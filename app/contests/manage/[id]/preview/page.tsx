...
export default async function ContestManagePreviewPage({
  params,
}: {
  ...
  const nominations = isDemoContest ? [] : await getContestNominations(id)
  const allowedTypes =
      ...
      <div className="mx-auto flex w-full max-w-md flex-col gap-6 px-4 pb-24 pt-6 sm:max-w-5xl">
        <header className="flex items-end justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black">Non-owner View</h1>
          </div>
          <Link
