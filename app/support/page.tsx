  ...
  return (
    <main className="min-h-screen bg-[#061012] pb-24 text-slate-100">
      <div className="mx-auto flex w-full max-w-md flex-col gap-5 px-4 pt-5">
        <section className="relative rounded-3xl border border-cyan-400/20 bg-gradient-to-br from-cyan-400/10 via-white/[0.04] to-white/[0.02] p-5 pt-16 shadow-xl shadow-black/20">
          <div className="absolute left-4 top-4 z-20">
            <BackButton fallbackHref="/dashboard" />
          </div>

          <div className="absolute right-4 top-4 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-xs font-semibold text-cyan-200">
            Support
          </div>
