    ...
    <div className="grid gap-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        {Array.from({ length: 6 }).map((_, index) => (
          <div
            key={index}
            className="min-h-[86px] animate-pulse rounded-xl border border-white/10 bg-white/5 p-3"
          >
...
export function ContestCardSkeleton() {
  return (
    <div className="grid min-h-[348px] animate-pulse grid-rows-[180px_1fr] overflow-hidden rounded-2xl border border-cyan-300/20 bg-cyan-300/[0.06]">
...
export function BenchUnitsSkeleton() {
  return (
    <div className="min-h-[188px] animate-pulse rounded-3xl border border-white/10 bg-white/5 p-5">
      <div className="flex items-center justify-between">
        <div className="h-4 w-36 rounded bg-white/10" />
